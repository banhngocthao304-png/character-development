...
- [ ] Meals: clean collapsible Food Options view with search and per-category edit mode
- [ ] Global compact typography and spacing refinement across mobile and desktop
